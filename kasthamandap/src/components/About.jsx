  ...
  return (
    <div className="flex flex-row w-full bg-white">
      ...
      <div className="basis-1/2 ml-10">
        <p className="mt-20 text-6xl italic font-bold font-dancing underline underline-offset-4 leading-relaxed">
          About Us
        </p>
        ...
        <p className="leading-relaxed text-xl font-cursive">
          Kasthamandap restautant's lunch menu has many popular dishes like
