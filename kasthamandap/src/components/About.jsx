...
const About = () => {
    return (
      <div className="flex flex-row w-full bg-white">
        <div className="flex basis-1/2 mt-5 ml-10 w-full">
            ...
            <div className="flex-column ml-10 mt-10 ">
                <img className="object-cover h-64 w-96 rounded-lg" src="../src/Images/dhido.jpg" alt="Image Description"></img>
                <img className="object-cover h-64 w-96 mt-10 rounded-lg" src="../src/Images/Dal_Bhat_Tarkari.jpeg" alt="Image Description"></img>
            </div>
        </div>
